...
//       onSlotRequest: 'slot-request' as EventName<SlotRequest>,
//     });
//   }
...
//       // element renderer.
//       if (React.createElement.name === 'litPatchedCreateElement' && Object.keys(elementProps).length) {
...
//             html`${requestRenderer(renderProps[prop], ctx, elementRef.current as HTMLElement)}`;
...
//           renderers.set(
//             event.slotName,
//             createPortal((portals[event.name] as any)?.(event.data), event.node, event.slotName),
//           );
//         }
...
//       outProps.children = [...React.Children.toArray(props.children as unknown as ReactNode[]), ...renderers.values()];
//     }
